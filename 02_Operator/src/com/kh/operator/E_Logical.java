...
public class E_Logical {
	 ...
	 * 논리연산한 결과마저도 논리값임!
	 * 
	 * 논리값 && 논리값 : 왼쪽과 오른쪽 둘다 true 일 경우 결과값은 true // (& : and)
	 * 논리값 || 논리값 : 왼쪽과 오른쪽 둘중에 하나라도 true일 경우 결과값은 true // (| : or)
	 */
	...
	public void method2() {
		...
		// boolean result = (65 <= ch >= 90); //불가능
		
		// 첫번째 방법
		//boolean result = (ch >= 65) && (ch <= 90); //가능
	...
	public void method3() {
		...
		//		두개의 조건 중 모두 false 이면 || 연산의 결과값은 false
	 ...
	 *  
	 *  true && true	=> true		(둘다!일때만 true)
	 *  true && false	=> false
	 *  false && true	=> false
	 *  false && false	=> false
	 *  
	 *  ** && 연산자를 기준으로 앞의 결과가 false일 경위 뒤의 조건은 굳이 실행하지 않는다 **  => 아묻따 false
	 *  
	 *  -------------------
	 *  
	 *  || : 두개의 조건 중 하나라도 true라면 결과값이 true임 (OR == ~이거나, 또는)
	 *  
	 *  true || true	=> true		(하나라도!충족하면 true)
	 *  true || false	=> true
	 *  false || true	=> true
	 *  false || false	=> false
	 *  
	 *  ** || 연산자 기준으로 앞의 결과가 true일 경우 뒤의 조건은 굳이 실행하지 않는다 **  => 아묻따 true
	 *  
	 */
	...
	public void method5() {
		...
		int num = 10;
		//boolean result1 = (num < 5) && (++num > 0); //가능, 앞이 이미 false라서 뒤는 실행시키지x => 따라서 num값 증가x
		...
		int num2 = 10;
		//boolean result2 = (num2 > 20) || (++num2 > 0); //가능, 앞이 false라서 뒤에까지 실행o => 따라서 num2값 증가o
